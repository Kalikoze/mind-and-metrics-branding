...
const SectionHeading = ({ children }: { children: React.ReactNode }) => (
  <h2 className="font-serif text-2xl text-dark-800 mb-6 
...
const SubHeading = ({ children }: { children: React.ReactNode }) => (
  <h3 className="font-serif text-xl text-dark-800 mb-3 
            ...
            <div className="bg-white rounded-lg shadow-lg border-2 border-neutral-200 p-8 sm:p-12">
              <div className="mb-12" data-cy="job-header">
                ...
                <div className="flex flex-wrap gap-4 mb-6" data-cy="job-meta">
                  <div data-cy="job-type" className="flex items-center gap-2 text-dark-600 bg-neutral-50 px-4 py-2 rounded-full">
                    <HiOutlineBriefcase className="w-5 h-5" />
                    <span>{position.type}</span>
                  </div>
                  <div data-cy="job-location-type" className="flex items-center gap-2 text-dark-600 bg-neutral-50 px-4 py-2 rounded-full">
                    <HiOutlineMapPin className="w-5 h-5" />
                    <span>{position.locationType}</span>
                  </div>
                  <div data-cy="job-location" className="flex items-center gap-2 text-dark-600 bg-neutral-50 px-4 py-2 rounded-full">
